                  ...
                  <a className='nav-link' href='#details'>
                    ...
                    <main role='main' className={`ml-sm-auto px-4 ${styles.content}`}>
                        ...
                        <section id='overview' className={styles.section}>
                            <div className='wrap'>
                                <h1 className='font-lato text-4xl font-bold text-left mt-5'> Sky
                                </h1>
                                <p className='font-playfair text-left text-2xl mt-3'>
                                    An AI Career Coach Made for Tech Professionals
                                </p>
                                <p className='text-left text-xl mt-4 font-light'>
                                    I have been a part-time AI Product Designer at Radical AI
                                    over the past 2 months. I was on the Sky's Learning Modules
                                    team. There was no specified direction given on which the product needs to head to. I knew <b>I must figure out
                                        the current design's limitations & make Sky's design more enjoyble and intuitive.</b>
                                </p>
                                <h3 className='border-b-2 mt-5 text-left text-2xl pb-2'>
                                    Outcomes
                                </h3>
                                <p className='text-left text-xl mt-4 font-light'>
                                    I independently researched & designed over 20 screens of Sky's Learning Modules in 3 weeks & conducted usability testing in 1 week.
                                </p>
                                {/* <div className='flex'>
                    ...
                    <p className='mt-4 text-left font-light'>
                      ...
                      here:
                        ...
                        <section id='research' className={styles.section}>
                            <div className='wrap'>
                                <h2 className='text-5xl py-9'>User Research</h2>
                                <div className='md:flex xs:flex-col'>
                                    <p className='font-playfair text-leftfont-light text-xl mx-16 mb-9'>
                                        To discover product opportunities, I conducted competitor analysis.
                                    </p>
                                </div>
                                <div className='mx-9'><Image
                                    src='/img/sky-competitor-analysis.png'
                                    width={1000}
                                    height={400}
                                ></Image></div>
                        ...
                        <section id='code' className={styles.section}>
                            <div className='wrap'>
                                ...
                                <div className='md:flex xs:flex-col'>
                                    ...
                                    <div className='my-4'>
                                        <Button variant="dark" href="https://www.figma.com/design/Nkgt6VSOc96jhleaksiYhB/movie-theatre-snacks-ordering-app?node-id=284-149&t=5wABIHRbRAT8soqY-0">View Prototype</Button>
                                    </div>
                                </div>
